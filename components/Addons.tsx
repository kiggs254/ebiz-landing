...
const ADDONS = [
  ...
  { key: "areas", name: "Area Rate Cards", desc: "Import your courier's zones & drop-point prices.", cat: "ops" },
  { key: "riders", name: "Delivery Riders", desc: "Your own delivery team — assign, notify on WhatsApp, hand a packing slip.", cat: "ops" },
  { key: "reservations", name: "Reservations", desc: "Table bookings for restaurants: hours, capacity, reminders.", cat: "ops" },
  ...
  { key: "whatsapp", name: "WhatsApp Cloud", desc: "Official Meta Business API — templates, buttons & rich media.", cat: "messaging" },
  { key: "wa_selfhosted", name: "WhatsApp Self-Hosted", desc: "Use your own number — no template approval, no per-message fee.", cat: "messaging" },
...
export default function Addons() {
  ...
  const sidebar: Array<[string, boolean, string | null]> = [
    ...
    ["Reservations", enabled.reservations, "var(--blue)"],
    ["Riders", enabled.riders, "var(--blue)"],
    ...
    ["WhatsApp", enabled.whatsapp || enabled.wa_selfhosted, "var(--green)"],
